...
namespace IfoodApi.Migrations
{
    ...
    [Migration("20221104210715_adcionand produtos")]
    partial class adcionandprodutos
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IfoodApi.Models.Produto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IfoodApi.Models.Produto", b =>
                {
                    b.HasOne("IfoodApi.Models.Restaurante", "Restaurante")
                        .WithMany("Produtos")
